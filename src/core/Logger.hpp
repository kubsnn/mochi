#pragma once
#ifndef __APP_CORELOGGER_HPP__
#define __APP_CORELOGGER_HPP__
...
namespace mochi::core {
    ...
    public:
        ...
        inline explicit Logger(std::ostream& os)
            : os_(os)
        { }
    ...
    public:
        ...
        class LogEntryDebug {
        public:
            inline explicit LogEntryDebug(Logger& logger)
                : logger_(logger), lock_(logger.mutex_)
            {
